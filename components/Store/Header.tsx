      ...
      <div className="px-4 flex justify-between flex-col md:flex-row gap-4">
        <div className="flex justify-between flex-row md:flex-col gap-4">
          <div className="flex gap-2 items-center">
            <div>
              <p className="text-2xl text-[#AB7BFF] whitespace-nowrap">
                Amber #1223
              </p>
              <p className="text-white">1 of 1 available</p>
            </div>
            <img src="/icons/scan-icon.svg" alt="" className="w-6 md:w-10" />
          </div>

          <div className="text-[#441F84] max-w-[200px] text-right md:text-left">
        ...
        <div className="flex justify-between  flex-col gap-4">
          ...
          <button className="bg-[#FC0FF54D] text-white border-0 py-4 px-20 uppercase rounded-full">
            Buy
